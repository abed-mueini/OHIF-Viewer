...
const messages: Record<string, string> = {
  ...
  invalid_credentials_or_account_state: 'ایمیل، رمز عبور یا وضعیت حساب معتبر نیست.',
  no_active_account: 'ایمیل، رمز عبور یا وضعیت حساب معتبر نیست.',
  ...
  invalid_mobile_number: 'شماره موبایل را با کد کشور وارد کنید.',
