...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'text-muted-foreground h-10 px-2 text-start align-middle font-medium [&:has([role=checkbox])]:[padding-inline-end:0] [&>[role=checkbox]]:translate-y-[2px]',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'p-2 align-middle [&:has([role=checkbox])]:[padding-inline-end:0] [&>[role=checkbox]]:translate-y-[2px]',
      className
    )}
    {...props}
  />
